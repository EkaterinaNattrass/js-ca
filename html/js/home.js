...
const anotherUrl = 'https://corsproxy.io/?' + encodeURIComponent('https://www.thecocktaildb.com/api/json/v1/1/random.php');
const thirdUrl = 'https://corsproxy.io/?' + encodeURIComponent('https://www.thecocktaildb.com/api/json/v1/1/random.php');
...
const getCocktail = async function(){
    ...
    try {const response =  await fetch(anotherUrl);
        const object = await response.json();
        ...
        try {const response =  await fetch(thirdUrl);
            const object = await response.json();
